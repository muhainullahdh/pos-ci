                    ...
                    <div class="media media-wrapper justify-content-between">
                      <div class="media-body">
                        <div class="greeting-user">
                          <h4 class="f-w-600">Selamat datang di POS</h4>
                          <p>Application Management POS</p>
                          <div class="whatsnew-btn"><a class="btn btn-outline-white"><?= date('Y-m') ?></a></div>
                        </div>
                      </div>
                      <div>
                        <div class="clockbox">
                    ...
                    <div class="card widget-1">
                      <div class="card-body">
                        <div class="widget-content">
                          ...
                          <div>
                            <h4>10,000</h4><span class="f-light">Purchasing</span>
                          </div>
                        </div>
                      ...
                      <div class="card widget-1">
                        <div class="card-body">
                          <div class="widget-content">
                            ...
                            <div>
                              <h4>5700</h4><span class="f-light">Total Produk</span>
                            </div>
                          </div>
                ...
                <div class="row">
                  <div class="col-xxl-12 col-xl-6 box-col-12">
                    <div class="card widget-1 widget-with-chart">
                      <div class="card-body">
                        <div>
                          <h4 class="mb-1">1,80k</h4><span class="f-light">Pembelian</span>
                        </div>
                  ...
                  <div class="col-xxl-12 col-xl-6 box-col-12">
                    <div class="card widget-1 widget-with-chart">
                      <div class="card-body">
                        <div>
                          <h4 class="mb-1">6,90k</h4><span class="f-light">Keuntungan</span>
                        </div>
