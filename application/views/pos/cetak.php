...
<table>
    ...
    <tr>
        ...
        <td style="font-size:14px;"><?=  $this->db->get_where('ekspedisi',['id' => $transkasi['pengiriman']])->row_array()['kurir'] == "Internal" ? "Ambil ditoko" : "Ekspedisi"; ?></td>
    </tr>
    <!-- <tr>
        <td>Pengirim </td>
    ...
    <tr>
        <td colspan="2" width="150" style="text-align: center; vertical-align: middle;font-size:12px;">Barang yang sudah dibeli tidak dapat di kembalikan
