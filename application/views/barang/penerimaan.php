                                ...
                                <form action="<?= base_url('barang/penerimaan') ?>" method="post">
                                    <div class="row">
                                            ...
                                            <div class="col-xl-4">
                                                ...
                                                <input required type="text" placeholder="abc" name="penerimaan" class="form-control">
                                            </div>
                                    </div>
                                    <div class="row mt-3">
...
<script>
               $(document).on('click', '.delete_penerimaan', function (e) {
                        e.preventDefault();
                        var pid = this.id;
                        swal({
                            title: "Delete",
                            text: "Apakah anda yakin ingin delete penerimaan?",
                            icon: "warning",
                            buttons: true,
                            dangerMode: true,
                        }).then((willDelete) => {
                            if (willDelete) {
                                $.ajax({
                                url : "<?= site_url('barang/delete_penerimaan');?>",
                                method : "POST",
                                data : {id: pid},
                                async : true,
                                dataType : 'json',
                                    success: function(data){
                                        swal({
                                                                title: "Berhasil..!",
                                                                text: "penerimaan berhasil didelete",
                                                                icon: "success",
                                                                }).then((willDelete) => {
                                                                if (willDelete) {
                                                                    location.reload();
