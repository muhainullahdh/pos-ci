            ...
            foreach ($object->getWorksheetIterator() as $worksheet) {
                ...
                for ($row = 2; $row <= $highestRow; $row++) {
                    ...
                    $temp_data[] = array(
                        ...
                        'id_satuan_kecil'    => $worksheet->getCellByColumnAndRow(3, $row)->getValue(),
                        'id_satuan_kecil_konv'    => $worksheet->getCellByColumnAndRow(4, $row)->getValue(),
                        'qty_besar'    => $worksheet->getCellByColumnAndRow(5, $row)->getValue(),
                        'qty_kecil'    => $worksheet->getCellByColumnAndRow(6, $row)->getValue(),
                        'qty_konv'    => $worksheet->getCellByColumnAndRow(7, $row)->getValue(),
                        'hpp_besar'    => $worksheet->getCellByColumnAndRow(8, $row)->getValue(),
                        'hpp_kecil'    => $worksheet->getCellByColumnAndRow(9, $row)->getValue(),
                        'hpp_konv'    => $worksheet->getCellByColumnAndRow(10, $row)->getValue(),
                        'hargajualb_retail'    => $worksheet->getCellByColumnAndRow(11, $row)->getValue(),
                        'hargajualk_retail'    => $worksheet->getCellByColumnAndRow(12, $row)->getValue(),
                        'hargajual_konv_retail'    => $worksheet->getCellByColumnAndRow(13, $row)->getValue(),
                        'hargajualb_grosir'    => $worksheet->getCellByColumnAndRow(14, $row)->getValue(),
                        'hargajualk_grosir'    => $worksheet->getCellByColumnAndRow(15, $row)->getValue(),
                        'hargajual_konv_grosir'    => $worksheet->getCellByColumnAndRow(16, $row)->getValue(),
                        'hargajualb_partai'    => $worksheet->getCellByColumnAndRow(17, $row)->getValue(),
                        'hargajualk_partai'    => $worksheet->getCellByColumnAndRow(18, $row)->getValue(),
                        'hargajual_konv_partai'    => $worksheet->getCellByColumnAndRow(19, $row)->getValue(),
                        'hargajualb_promo'    => $worksheet->getCellByColumnAndRow(20, $row)->getValue(),
                        'hargajualk_promo'    => $worksheet->getCellByColumnAndRow(21, $row)->getValue(),
                        'hargajual_konv_promo'    => $worksheet->getCellByColumnAndRow(22, $row)->getValue(),
